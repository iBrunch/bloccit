...
RSpec.describe User, type: :model do
  ...
  describe "invalid user" do
    let(:user_with_invalid_name) { User.new(name: "", email: "user@bloccit.com", password: "helloworld") }
    let(:user_with_invalid_email) { User.new(name: "Bloccit User", email: "", password: "helloworld") }
